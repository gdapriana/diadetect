      ...
      >
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 md:gap-4 gap-2">
          <label
            ...
            className="flex flex-col justify-between items-start p-8 hover:bg-neutral-50 ease-in-out duration-300 rounded-xl border"
          >
        ...
        <button
          className="flex justify-center items-center font-semibold text-neutral-100 bg-neutral-800 py-4 px-8 rounded-xl gap-2"
          type={"submit"}
        >
